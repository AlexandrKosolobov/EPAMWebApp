package by.kosolobov.barbershop.base.controller;

import by.kosolobov.barbershop.base.command.CommandDefiner;
...
public class FrontController extends HttpServlet {
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Command command = CommandDefiner.define(strCommand);
